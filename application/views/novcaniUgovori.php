...
<?php foreach ($novcaniUgovori as $nugovor) { ?>
    <?php if ($nugovor['idstatus_ugovora'] != '6') { ?>
        <table class="table table-striped table-bordered">
            <tbody>
                <tr><td colspan="2"> <?php echo "<h3>" . $nugovor['naziv'] . "</h3>"; ?></td></tr>
                <?php
                echo "<tr><td>Datum potpisivanja:</td><td> " . $nugovor['datum_potpisivanja'] . "</td></tr>";
                echo "<tr><td>Datum isticanja:</td><td> "
                ?><?php
                if ($danasnjiDatum > $nugovor['datum_isticanja']) {
                ...
                <tr>
                    <?php echo form_open("$kontroler/promeniPodatkeUgovora", "method=GET"); ?>
                    <td>
                        <?php echo form_label("Faktura: &nbsp "); ?></td>
            ...
            <td><input type="checkbox" name="faktura" value="1" <?php
                ...
                ?> /></td></tr>
        <tr><td> <?php echo "Uplata: &nbsp "; ?></td>
            <td> <input type="checkbox" name="uplata" value="1" <?php
                if ($nugovor['uplata'] == 1) {
                    echo 'checked';
                }
                ?> /></td></tr>
        <tr><td>  <?php echo "Datum uplate: "; ?></td>
            <td> <input class="form-control" style="width: 45%;" placeholder="Datum uplate" name="datum_uplate" type="date" value="<?php
                if ($nugovor['datum_uplate'] != NULL) {
                    echo $nugovor['datum_uplate'];
                }
                ?>"></td></tr>
        <tr><td>   <?php echo "Status ugovora: "; ?></td>
            <td> <div class="form-group">                                
                    <select class="form-control" style="width: 45%;" name="status_ugovora" value="<?php echo $nugovor['opis']; ?>" >
        ...
        <tr><td> <?php echo "Komentar:<br/ >"; ?></td>
            <td> <textarea rows="4" cols="70" name="komentar"><?php
                    if ($nugovor['komentar'] != NULL) {
