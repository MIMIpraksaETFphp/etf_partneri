            ...
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group col-md-6 m-0">
                        ...
                        <textarea class="form-control m-0" rows="10" name="oglastext" id="oglastext"><?php echo set_value('oglastext'); ?></textarea>
                        <script>
                            CKEDITOR.replace("oglastext");
                        </script>    </div>                
                        <span class="message col-md-6"><?php echo form_error('oglastext'); ?></span>
                    <div class="form-checkbox p-0"> 
                    ...
                    <br />
                    <div class="form-group">
                        <br /><br /><br />File .pdf: <input type="file" name="fajl" /><br>
                    </div>
                    <div class="form-group">
